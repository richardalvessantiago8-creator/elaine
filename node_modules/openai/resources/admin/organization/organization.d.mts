...
import * as ExternalStorageAPI from "./external-storage.mjs";
import { AwsExternalStorageProvider, AzureExternalStorageProvider, ExternalStorage, ExternalStorageConfiguration, ExternalStorageConfigurationsPage, ExternalStorageCreateParams, ExternalStorageDeleted, ExternalStorageListParams } from "./external-storage.mjs";
...
import { Project, ProjectCreateParams, ProjectListParams, ProjectResidency, ProjectUpdateParams, Projects, ProjectsPage } from "./projects/projects.mjs";
...
export declare class Organization extends APIResource {
    externalStorage: ExternalStorageAPI.ExternalStorage;
...
export declare namespace Organization {
    export { ExternalStorage as ExternalStorage, type AwsExternalStorageProvider as AwsExternalStorageProvider, type AzureExternalStorageProvider as AzureExternalStorageProvider, type ExternalStorageConfiguration as ExternalStorageConfiguration, type ExternalStorageDeleted as ExternalStorageDeleted, type ExternalStorageConfigurationsPage as ExternalStorageConfigurationsPage, type ExternalStorageCreateParams as ExternalStorageCreateParams, type ExternalStorageListParams as ExternalStorageListParams, };
    ...
    export { Projects as Projects, type Project as Project, type ProjectResidency as ProjectResidency, type ProjectsPage as ProjectsPage, type ProjectCreateParams as ProjectCreateParams, type ProjectUpdateParams as ProjectUpdateParams, type ProjectListParams as ProjectListParams, };
}
