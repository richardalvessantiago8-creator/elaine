...
const ExternalStorageAPI = tslib_1.__importStar(require("./external-storage.js"));
const external_storage_1 = require("./external-storage.js");
...
class Organization extends resource_1.APIResource {
    constructor() {
        super(...arguments);
        this.externalStorage = new ExternalStorageAPI.ExternalStorage(this._client);
...
Organization.ExternalStorage = external_storage_1.ExternalStorage;
...
Organization.SpendLimit = spend_limit_1.SpendLimit;
