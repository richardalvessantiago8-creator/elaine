...
export declare class InputItems extends APIResource {
     ...
     * ```
     */
    list(responseID: string, query?: (InputItemListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<ResponseItemsPage, ResponsesAPI.ResponseItem>;
    list(responseID: string, options?: {
