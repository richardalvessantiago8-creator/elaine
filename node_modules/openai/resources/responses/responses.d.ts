...
export declare class Responses extends APIResource {
     ...
     * ```
     */
    retrieve(responseID: string, query?: ResponseRetrieveParamsNonStreaming & ({
        [K in 'method' | 'path' | 'query' | 'body' | 'headers' | 'maxRetries' | 'timeout' | 'httpAgent' | 'fetchOptions' | 'signal' | 'idempotencyKey' | 'defaultBaseURL' | '__metadata' | '__binaryRequest' | '__binaryResponse' | '__streamClass' | '__security' | '__synthesizeEventData']?: never;
    } | null | undefined), options?: RequestOptions): APIPromise<Response>;
    retrieve(responseID: string, query: ResponseRetrieveParamsStreaming & ({
        [K in 'method' | 'path' | 'query' | 'body' | 'headers' | 'maxRetries' | 'timeout' | 'httpAgent' | 'fetchOptions' | 'signal' | 'idempotencyKey' | 'defaultBaseURL' | '__metadata' | '__binaryRequest' | '__binaryResponse' | '__streamClass' | '__security' | '__synthesizeEventData']?: never;
    } | null | undefined), options?: RequestOptions): APIPromise<Stream<ResponseStreamEvent>>;
    retrieve(responseID: string, query?: (ResponseRetrieveParamsBase & ({
        [K in 'method' | 'path' | 'query' | 'body' | 'headers' | 'maxRetries' | 'timeout' | 'httpAgent' | 'fetchOptions' | 'signal' | 'idempotencyKey' | 'defaultBaseURL' | '__metadata' | '__binaryRequest' | '__binaryResponse' | '__streamClass' | '__security' | '__synthesizeEventData']?: never;
    } | null | undefined)) | undefined, options?: RequestOptions): APIPromise<Stream<ResponseStreamEvent> | Response>;
    retrieve(responseID: string, options?: {
...
export declare namespace McpToolCallError {
...
export interface ResponseOutputTextAnnotationAddedEvent {
     ...
     */
    annotation: ResponseOutputTextAnnotationAddedEvent.FileCitation | ResponseOutputTextAnnotationAddedEvent.URLCitation | ResponseOutputTextAnnotationAddedEvent.ContainerFileCitation | ResponseOutputTextAnnotationAddedEvent.FilePath | null;
    /**
...
export declare namespace ResponseOutputTextAnnotationAddedEvent {
    /**
     * A citation to a file.
     */
    interface FileCitation {
...
export declare namespace ResponseShellCallOutputContentDeltaEvent {
    /**
     * The stdout/stderr delta that was emitted.
     */
    interface Delta {
...
export declare namespace ResponseShellCallOutputContentDoneEvent {
    /**
     * The content of a shell tool call output that was emitted.
     */
    interface Output {
...
export declare namespace ResponsesServerEvent {
     ...
     * Emitted when the audio response is complete.
     */
    interface ResponseAudioWsDone extends ResponseAudioDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when there is a partial transcript of audio.
     */
    interface ResponseAudioTranscriptWsDelta extends ResponseAudioTranscriptDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the full audio transcript is completed.
     */
    interface ResponseAudioTranscriptWsDone extends ResponseAudioTranscriptDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a partial code snippet is streamed by the code interpreter.
     */
    interface ResponseCodeInterpreterCallCodeWsDelta extends ResponseCodeInterpreterCallCodeDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the code snippet is finalized by the code interpreter.
     */
    interface ResponseCodeInterpreterCallCodeWsDone extends ResponseCodeInterpreterCallCodeDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the code interpreter call is completed.
     */
    interface ResponseCodeInterpreterCallWsCompleted extends ResponseCodeInterpreterCallCompletedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a code interpreter call is in progress.
     */
    interface ResponseCodeInterpreterCallInWsProgress extends ResponseCodeInterpreterCallInProgressEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the code interpreter is actively interpreting the code snippet.
     */
    interface ResponseCodeInterpreterCallWsInterpreting extends ResponseCodeInterpreterCallInterpretingEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * no summary content.
     */
    interface ResponseCompactionWsCompacting extends ResponseCompactionCompactingEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the model response is complete.
     */
    interface ResponseWsCompleted extends ResponseCompletedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a new content part is added.
     */
    interface ResponseContentPartWsAdded extends ResponseContentPartAddedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a content part is done.
     */
    interface ResponseContentPartWsDone extends ResponseContentPartDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * An event that is emitted when a response is created.
     */
    interface ResponseWsCreated extends ResponseCreatedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a file search call is completed (results found).
     */
    interface ResponseFileSearchCallWsCompleted extends ResponseFileSearchCallCompletedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a file search call is initiated.
     */
    interface ResponseFileSearchCallInWsProgress extends ResponseFileSearchCallInProgressEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a file search is currently searching.
     */
    interface ResponseFileSearchCallWsSearching extends ResponseFileSearchCallSearchingEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when there is a partial function-call arguments delta.
     */
    interface ResponseFunctionCallArgumentsWsDelta extends ResponseFunctionCallArgumentsDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when function-call arguments are finalized.
     */
    interface ResponseFunctionCallArgumentsWsDone extends ResponseFunctionCallArgumentsDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * A streaming event that indicated a shell command was added to a tool call.
     */
    interface ResponseShellCallCommandWsAdded extends ResponseShellCallCommandAddedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * A streaming event that indicated a shell command was incrementally updated.
     */
    interface ResponseShellCallCommandWsDelta extends ResponseShellCallCommandDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * A streaming event that indicated a shell command was completed.
     */
    interface ResponseShellCallCommandWsDone extends ResponseShellCallCommandDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * A streaming event that indicated shell call output was incrementally added.
     */
    interface ResponseShellCallOutputContentWsDelta extends ResponseShellCallOutputContentDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * A streaming event that indicated shell call output was completed.
     */
    interface ResponseShellCallOutputContentWsDone extends ResponseShellCallOutputContentDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the response is in progress.
     */
    interface ResponseInWsProgress extends ResponseInProgressEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * An event that is emitted when a response fails.
     */
    interface ResponseWsFailed extends ResponseFailedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a new output item is added.
     */
    interface ResponseOutputItemWsAdded extends ResponseOutputItemAddedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when an output item is marked done.
     */
    interface ResponseOutputItemWsDone extends ResponseOutputItemDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a new reasoning summary part is added.
     */
    interface ResponseReasoningSummaryPartWsAdded extends ResponseReasoningSummaryPartAddedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a reasoning summary part is completed.
     */
    interface ResponseReasoningSummaryPartWsDone extends ResponseReasoningSummaryPartDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a delta is added to a reasoning summary text.
     */
    interface ResponseReasoningSummaryTextWsDelta extends ResponseReasoningSummaryTextDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a reasoning summary text is completed.
     */
    interface ResponseReasoningSummaryTextWsDone extends ResponseReasoningSummaryTextDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a delta is added to a reasoning text.
     */
    interface ResponseReasoningTextWsDelta extends ResponseReasoningTextDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a reasoning text is completed.
     */
    interface ResponseReasoningTextWsDone extends ResponseReasoningTextDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when there is a partial refusal text.
     */
    interface ResponseRefusalWsDelta extends ResponseRefusalDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when refusal text is finalized.
     */
    interface ResponseRefusalWsDone extends ResponseRefusalDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when there is an additional text delta.
     */
    interface ResponseTextWsDelta extends ResponseTextDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when text content is finalized.
     */
    interface ResponseTextWsDone extends ResponseTextDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a web search call is completed.
     */
    interface ResponseWebSearchCallWsCompleted extends ResponseWebSearchCallCompletedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a web search call is initiated.
     */
    interface ResponseWebSearchCallInWsProgress extends ResponseWebSearchCallInProgressEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a web search call is executing.
     */
    interface ResponseWebSearchCallWsSearching extends ResponseWebSearchCallSearchingEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * available.
     */
    interface ResponseImageGenCallWsCompleted extends ResponseImageGenCallCompletedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * (intermediate state).
     */
    interface ResponseImageGenCallWsGenerating extends ResponseImageGenCallGeneratingEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when an image generation tool call is in progress.
     */
    interface ResponseImageGenCallInWsProgress extends ResponseImageGenCallInProgressEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a partial image is available during image generation streaming.
     */
    interface ResponseImageGenCallPartialWsImage extends ResponseImageGenCallPartialImageEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * call.
     */
    interface ResponseMcpCallArgumentsWsDelta extends ResponseMcpCallArgumentsDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the arguments for an MCP tool call are finalized.
     */
    interface ResponseMcpCallArgumentsWsDone extends ResponseMcpCallArgumentsDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when an MCP tool call has completed successfully.
     */
    interface ResponseMcpCallWsCompleted extends ResponseMcpCallCompletedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when an MCP tool call has failed.
     */
    interface ResponseMcpCallWsFailed extends ResponseMcpCallFailedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when an MCP tool call is in progress.
     */
    interface ResponseMcpCallInWsProgress extends ResponseMcpCallInProgressEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the list of available MCP tools has been successfully retrieved.
     */
    interface ResponseMcpListToolsWsCompleted extends ResponseMcpListToolsCompletedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when the attempt to list available MCP tools has failed.
     */
    interface ResponseMcpListToolsWsFailed extends ResponseMcpListToolsFailedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * MCP tools.
     */
    interface ResponseMcpListToolsInWsProgress extends ResponseMcpListToolsInProgressEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when an annotation is added to output text content.
     */
    interface ResponseOutputTextAnnotationWsAdded extends ResponseOutputTextAnnotationAddedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Emitted when a response is queued and waiting to be processed.
     */
    interface ResponseWsQueued extends ResponseQueuedEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Event representing a delta (partial update) to the input of a custom tool call.
     */
    interface ResponseCustomToolCallInputWsDelta extends ResponseCustomToolCallInputDeltaEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     * Event indicating that input for a custom tool call is complete.
     */
    interface ResponseCustomToolCallInputWsDone extends ResponseCustomToolCallInputDoneEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
     ...
     */
    interface ResponseWsStreamingError extends ResponseErrorEvent {
        /**
         * The WebSocket lane that emitted this event. This field is present when the
         * originating `response.create` event supplied a `stream_id`.
         */
