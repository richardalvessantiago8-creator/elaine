...
const file_processing_1 = require("../lib/file-processing.js");
...
class Files extends resource_1.APIResource {
    ...
    list(query = {}, options) {
        const normalizeRequestOptionsForQueryOptions = normalizeRequestOptionsForQuery(query, ['after', 'limit', 'order', 'purpose'], options);
    ...
    async waitForProcessing(id, { pollInterval = 5000, maxWait = 30 * 60 * 1000 } = {}) {
        return await (0, file_processing_1.waitForFileProcessing)(this, id, pollInterval, maxWait);
    }
}
exports.Files = Files;
